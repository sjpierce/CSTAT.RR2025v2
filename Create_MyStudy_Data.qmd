...
If we give the `here()` function an relative path to a subfolder or file in the 
local repository, it will construct a path to that instead, as shown below. 
...
reproducibility purposes, I like to document the name, size, and last modified 
date for data files that I create. 
