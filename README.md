...
- [`Slides.qmd`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/Slides.qmd)
  *This script creates the slides.*
- [`Slides.html`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/output/Slides.html)
  *These are the final slides.*
- [`Create_MyStudy_Data.qmd`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/Create_MyStudy_Data.qmd)
  *This script creates the data used in the example report.*
- [`Create_MyStudy_Data.html`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/output/Create_MyStudy_Data.html)
  *This is the final output from creating the example data.*
- [`MyStudy_Report.qmd`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/MyStudy_Report.qmd)
  *This script creates the example report.*
- [`MyStudy_Report.html`](https://github.com/sjpierce/CSTAT.RR2025v2/blob/main/output/MyStudy_Report.html)
  *This is the final output for the example report.*
...
- `CSTAT.RR2025v2/`: This is the root folder for the repository.
  ...
  - `CSTAT.RR2025v2.Rproj`: This is an RStudio project file. It contains
